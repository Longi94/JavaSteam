...
public class SampleUnifiedMessages implements Runnable {
    ...
    private void onLoggedOn(LoggedOnCallback callback) {
        ...
        Chat chat = new Chat(steamUnifiedMessages);
        chat.RequestFriendPersonaStates(SteammessagesChatSteamclient.CChat_RequestFriendPersonaStates_Request.newBuilder().build());
    }
    ...
    private void onMethodResponse(ServiceMethodResponse callback) {
        ...
        System.out.println("ServiceMethodResponse getMethodName: " + callback.getMethodName());
        System.out.println("ServiceMethodResponse getResult: " + callback.getResult());
        System.out.println("ServiceMethodResponse getRpcName: " + callback.getRpcName());
        System.out.println("ServiceMethodResponse getServiceName: " + callback.getServiceName());
        System.out.println("ServiceMethodResponse getJobID: " + callback.getJobID());
    ...
    void onMethodNotification(ServiceMethodNotification callback) {
        Object cbObject = callback.getBody();
         ...
         System.out.println("onMethodNotification Method Name: " + callback.getMethodName());
         System.out.println("onMethodNotification RPC Name: " + callback.getRpcName());
         System.out.println("onMethodNotification Serive Name: " + callback.getServiceName());
         System.out.println("onMethodNotification Job ID: " + callback.getJobID());
    }
}
